    ...
    getCharacterCard(manifest, character, scenarios) {
        return {
            ...
            data: {
                ...
                character_version: '',
                extensions: { ...(character?.displayName && { 'full_name': character?.displayName }) }, // Preserve display name unmodified using extensions. "full_name" is not used by SillyTavern currently.
            },
