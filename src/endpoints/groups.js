...
router.post('/create', (request, response) => {
    ...
    const groupMetadata = {
        ...
        router_profile_id: request.body.router_profile_id ?? '',
        router_max_consecutive: request.body.router_max_consecutive ?? 4,
        router_system_prompt: request.body.router_system_prompt ?? '',
    };
