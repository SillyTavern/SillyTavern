...
router.post("/all", (request, response) => {
    ...
    files.forEach(function (file) {
        try {
            ...
            group["create_date"] = humanizedISO8601DateTime(
                groupStat.birthtimeMs,
            );
...
router.post("/create", (request, response) => {
    ...
    const groupMetadata = {
        ...
        generation_mode_join_prefix:
            request.body.generation_mode_join_prefix ?? "",
        generation_mode_join_suffix:
            request.body.generation_mode_join_suffix ?? "",
    };
