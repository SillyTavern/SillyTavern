...
Beginning in February 2023 as a fork of TavernAI 1.2.8, SillyTavern quickly became a leader and trendsetter for LLM frontend software. With now more than 100 contributors and almost 2 year of independent development, SillyTavern is considered an entirely different program from the original TavernAI.
