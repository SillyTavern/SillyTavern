...
- User report action with reason/details body and admin report queue with reported dates, bounded resolution notes, and resolve workflow for marketplace moderation.
