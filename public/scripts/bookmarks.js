...
function registerBookmarksSlashCommands() {
        ...
        SlashCommand.fromProps({
            ...
            callback: async (args, text) => {
                ...
                if (typeof text !== "string") {
                    toastr.warning(
                        "Checkpoint name must be a string or empty",
                        "Create Checkpoint",
                    );
                    return "";
                }

                const checkPointName = await createNewBookmark(mesId, {
                    forceName: text,
                });
    ...
    SlashCommandParser.addCommandObject(
        SlashCommand.fromProps({
            ...
            returns:
                "JSON array of all existing checkpoints in this chat, as an array",
...
export function initBookmarks() {
    ...
    $(document).on(
        "click",
        ".select_chat_block, .mes_bookmark",
        async function (e) {
