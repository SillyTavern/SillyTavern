...
export class SlashCommand {
    ...
    renderHelpDetails(key = null) {
        ...
        if (!this.helpDetailsCache[key]) {
            ...
            const aliasList = [cmd.name, ...(cmd.aliases ?? [])].filter(
                (it) => it != key,
            );
            const specs = document.createElement("div");
            {
                    ...
                    const src = document.createElement("div");
                    {
                        ...
                        if (this.isExtension) {
                            ...
                            if (this.isThirdParty)
                                src.classList.add("isThirdParty");
                ...
                const body = document.createElement("div");
                {
                                ...
                                const argSpec = document.createElement("div");
                                {
                                    ...
                                    if (arg.defaultValue !== null) {
                                        const argDefault =
                                            document.createElement("div");
                                        {
                                            argDefault.classList.add(
                                                "argument-default",
                                            );
                                            argDefault.title = "default value";
                                            argDefault.textContent =
                    ...
                    {
                        returns.classList.add("returns");
                        returns.title = [null, undefined, "void"].includes(
                            returnType,
                        )
