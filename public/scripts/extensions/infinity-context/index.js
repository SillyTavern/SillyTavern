...
function doAutoAdjust(chat, maxContext) {
    ...
    const messagesToKeep = Math.min(defaultSettings.keep_context_max, Math.max(5, Math.ceil(contextMessagesRounded * extension_settings.chromadb.keep_context_proportion / 5) * 5));
