    ...
    function l() {
        ...
        (u.I = []),
            ...
            (u.galleryDisplayTransitionDuration = {
                ...
                lN: 500,
                Get: function () {
                    return u.galleryDisplayTransitionDuration[
                        u.GOM.curNavLevel
                    ];
                },
            }),
        ...
        function S() {
                            ...
                            if (O.imageHeight > 0 && O.imageWidth > 0) {
                                ...
                                if (
                                    ...
                                    (O.resizedContentHeight =
                                        O.resizedContentWidth * G),
                                    b > 0)
                                ) {
                                    var M = Math.max(
                                        Math.trunc(O.resizedContentHeight / b),
                                        1,
                                    );
                                    O.resizedContentHeight =
                                        b * M + (M - 1) * (p + r);
            ...
            return (
                null !== t && ("function" == typeof t ? t() : window[t]()), e
            );
        }
        function L() {
            null == u.CSStransformName
        ...
        function q(e, t) {
            ...
            -1 != i
                ? (u.O.debugMode && console.log("#DisplayPhoto : " + i), Ie(i))
                : Z(t, q, e, t);
        }
        function Z(e, t, n, i) {
            switch (u.O.kind) {
        ...
        function ee() {
            ...
            (u.I[0].contentIsLoaded = !0),
                jQuery.each(u.O.items, function (n, a) {
                    ...
                    K(
                        (r =
                            void 0 !== a["src" + dt().toUpperCase()]
                                ? a["src" + dt().toUpperCase()]
                                : a.src),
                    ...
                    if (null === r)
                        if (u.VOM.viewerDisplayed) {
                            ...
                            "img" == e.mediaKind &&
                                ...
                                "img" == e.mediaKind &&
                                    u.VOM.ImageLoader.loadImage(et, e),
                                Je("");
                        } else Ne();
        ...
        function _e() {
            u.VOM.viewerDisplayed &&
                ((u.VOM.toolbarsDisplayed = !0), Pe(1), u.VOM.toolsHide());
        }
        function Pe(e) {
            ...
            if (!(new Date().getTime() - u.timeLastTouchStart < 300)) {
                ...
                if (null != i) {
                    switch (i) {
                        ...
                        case "info":
                            t.stopPropagation(),
                                Be(u.VOM.content.current.NGY2Item());
                            break;
                        case "close":
                            if (
                                (Ye(t),
        ...
        function Ze(e) {
            (e = e || 0),
                u.VOM.viewerMediaIsChanged ||
                    new Date().getTime() - u.VOM.timeImgChanged < 300 ||
                    (u.VOM.playSlideshow && Ue(),
                    ot("lightboxPreviousImage"),
                    Je("previousImage", e));
        }
        function Je(e, t) {
            (t = t || 0),
        ...
        function Ke(e) {
            ...
            "img" == r.mediaKind &&
                ...
                tt(u.VOM.content.previous, 0),
                "img" == r.mediaKind
                    ? u.VOM.ImageLoader.loadImage(et, r)
                ...
                if (u.O.thumbnailAlbumDisplayImage)
                    ...
                    null != e &&
                        (-1 == u.GOM.albumIdx
                            ...
                            : (x(),
                              lt(u.I[u.VOM.items[e].ngy2ItemIdx].albumID, ""),
                              W()));
                u.VOM.timeImgChanged = new Date().getTime();
            }
        }
     ...
     */ (e.nanogallery2 = function (e, t) {
                    ...
                    (r.makeJQueryPlugin = function (t) {
                        (t = t || e.jQuery) &&
                            ((n = t).fn.ngimagesLoaded = function (e, t) {
                                return new r(this, e, t).jqDeferred.promise(
                                    n(this),
                                );
                            });
                    }),
        ...
        (function (e, t, n, i) {
                    ...
                    (function (e, t) {
                        ...
                        (t.overallVelocityX = d.x),
                            ...
                            (t.scale = l
                                ? ((m = l.pointers),
                                  (p = a),
                                  H(p[0], p[1], _) / H(m[0], m[1], _))
                                : 1),
                            (t.rotation = l
                                ? (function (e, t) {
                                      return (
                                          U(t[1], t[0], _) + U(e[1], e[0], _)
                                      );
                                  })(l.pointers, a)
                                : 0),
            ...
            e.MSPointerEvent &&
                !e.PointerEvent &&
                ((J = "MSPointerDown"),
                (K = "MSPointerMove MSPointerUp MSPointerCancel")),
                f(ee, P, {
                    handler: function (e) {
                        var t = this.store,
                            n = !1,
            ...
            (Te.prototype = {
                ...
                dropRecognizeWith: function (e) {
                    return (
                        h(e, "dropRecognizeWith", this) ||
                            ((e = Le(e, this)), delete this.simultaneous[e.id]),
                        this
                    );
                },
                ...
                recognize: function (e) {
                    ...
                    if (!v(this.options.enable, [this, t]))
                        return this.reset(), void (this.state = Ie);
                    ...
                    process: function (e) {
                        ...
                        if (i && a && n) {
                            ...
                            var o =
                                ...
                                r =
                                    !this.pCenter ||
                                    H(this.pCenter, e.center) < t.posThreshold;
                            if (
