...
const quietPrompts = {
    ...
    [generationMode.FACE]: "In the next reponse I want you to provide a comma-delimited list of keywords and phrases which give a detailed description of {{char}}'s face and head. Do not describe anything below the neck. Do not write in complete sentences.",
