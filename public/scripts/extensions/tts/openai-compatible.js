...
class OpenAICompatibleTtsProvider {
    ...
    async loadSettings(settings) {
        ...
        $("#openai_compatible_tts_endpoint").val(
        ...
        $("#openai_compatible_tts_voices").val(
            this.settings.available_voices.join(),
        );
        ...
        $("#openai_compatible_tts_key").on("click", async () => {
            ...
            const savedKey = secret_state[SECRET_KEYS.CUSTOM_OPENAI_TTS]
                ? await findSecret(SECRET_KEYS.CUSTOM_OPENAI_TTS)
                : "";
    ...
    onSettingsChange() {
        // Update dynamically
        this.settings.provider_endpoint = String(
            $("#openai_compatible_tts_endpoint").val(),
        );
        this.settings.model = String($("#openai_compatible_model").val());
        this.settings.available_voices = String(
            $("#openai_compatible_tts_voices").val(),
        ).split(",");
