...
class SpeechT5TtsProvider {
    ...
    async loadSettings(settings) {
        ...
        $("#speecht5_tts_delete_speaker_button").on("click", () => {
            ...
            const speaker = this.settings.speakers.find(
                (s) => s.voice_id === this.settings.speaker,
            );
            if (!speaker) {
            ...
            $(
                `#speecht5_tts_speaker option[value="${speaker.voice_id}"]`,
            ).remove();
