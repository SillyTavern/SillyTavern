        ...
        switch (main_api) {
            ...
            case 'openai':
                if (((secret_state[SECRET_KEYS.OPENAI] || oai_settings.reverse_proxy) && oai_settings.chat_completion_source == chat_completion_sources.OPENAI)
                    ...
                    || (oai_settings.chat_completion_source === chat_completion_sources.POLLINATIONS && (oai_settings.pollinations_endpoint === 'anonymous' || secret_state[SECRET_KEYS.POLLINATIONS_KEY]))
