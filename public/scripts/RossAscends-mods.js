        ...
        switch (main_api) {
            ...
            case 'openai':
                if (((secret_state[SECRET_KEYS.OPENAI] || oai_settings.reverse_proxy) && oai_settings.chat_completion_source == chat_completion_sources.OPENAI)
                    ...
                    || (secret_state[SECRET_KEYS.POLLINATIONS_KEY] && oai_settings.chat_completion_source === chat_completion_sources.POLLINATIONS_KEY)
                    || (oai_settings.chat_completion_source === chat_completion_sources.POLLINATIONS_NOKEY)
