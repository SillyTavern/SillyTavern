        ...
        namedArgumentList: [
            SlashCommandNamedArgument.fromProps({
                ...
                enumList: [
                    ...
                    new SlashCommandEnumValue('gonkabroker', 'Gonka Broker', enumTypes.getBasedOnIndex(UNIQUE_APIS.findIndex(x => x === 'gonkabroker')), 'G'),
...
function getModelOptions(quiet) {
    ...
    const modelSelectMap = [
        ...
        { id: 'model_gonkabroker_select', api: 'openai', type: chat_completion_sources.GONKABROKER },
