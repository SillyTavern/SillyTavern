        ...
        namedArgumentList: [
            SlashCommandNamedArgument.fromProps({
                ...
                enumList: [
                    ...
                    new SlashCommandEnumValue('trustedrouter', 'TrustedRouter', enumTypes.getBasedOnIndex(UNIQUE_APIS.findIndex(x => x === 'trustedrouter')), 'T'),
...
function getModelOptions(quiet) {
    ...
    const modelSelectMap = [
        ...
        { id: 'model_trustedrouter_select', api: 'openai', type: chat_completion_sources.TRUSTEDROUTER },
