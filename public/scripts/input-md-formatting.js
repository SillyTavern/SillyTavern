...
export function initInputMarkdown() {
    $(document).on("keydown", "textarea.mdHotkeys", function (e) {
        ...
        if (isTextSelected) {
            ...
            if (
                selectedTextandPossibleFormatting ===
                charsToAdd + selectedText + charsToAdd
            ) {
                ...
                if (expandedEnd > textarea.value.length)
                    expandedEnd = textarea.value.length;
