 ...
 * @property {string?} [placeholder=null] - Placeholder text for the main interactive element (input field for INPUT type; use tooltip for additional hinter or content element hints for other)
