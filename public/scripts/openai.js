...
const default_impersonation_prompt = "[Write your next reply from the point of view of {{user}} {{input}}, using the chat history so far as a guideline for the writing style of {{user}}. Write 1 reply only in internet RP style. Don't write as {{char}} or system. Don't describe actions of {{char}}.]";
