                    ...
                    return this.running
                        ...
                        : this._q.length
                          ? ((this.running = this.dequeue().then(
                                function () {
                                    return (
                                        (this.running = void 0), this.flush()
                                    );
                                }.bind(this),
                            )),
                            this.running)
        ...
        function (t, e, i) {
            ...
            class c {
                ...
                load(t) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            return (
                                e.reject(new Error("No Document Available")), i
                            );
                        if (
                ...
                highlight(t, e = {}, i, n = "epubjs-hl", s = {}) {
                    ...
                    (e.epubcfi = t),
                        this.pane ||
                            (this.pane = new l.Pane(this.iframe, this.element));
            ...
            t.exports = function (t, e, i) {
                ...
                function S() {
                    ...
                    if (((h = arguments), (l = this), (f = t), i)) {
                        ...
                        if (m)
                            return (
                                clearTimeout(d), (d = setTimeout(x, e)), y(f)
                            );
                    }
        ...
        function (t, e, i) {
            ...
            class v {
                ...
                cfiFromPercentage(t) {
                    ...
                    return (
                        (e = Math.ceil(this.total * t)), this.cfiFromLocation(e)
                    );
                }
                load(t) {
                    return (
            ...
            var E = class {
                ...
                load(t) {
                    ...
                    return (
                        (this.spine = e.map(
                            (t, e) => (
                                (t.index = e), (t.linear = t.linear || "yes"), t
                            ),
                        )),
